const fkontak = {
    ...
    "message": {
        "conversation": `fightcentaur ${global.namebot || 'Bot'} ✨`,
    }
};
...
conn.level = global.db.data.users[m.sender]
  ...
  if (typeof conn.fightnaga[m.sender] != "undefined" && conn.fightnaga[m.sender] == true) return conn.reply(m.chat, `*Tidak Bisa Melakukan Battle Karena Arena Yang Kamu Miliki Diipakai Untuk Bertarung Pet Kamu Yang Lain.*`, fkontak) // Ditambahkan fkontak
  ...
  conn.reply(m.chat, `*Pet Kamu* (Centaur ${global.db.data.users[m.sender].centaur}) Nenantang Centaurnya *${conn.getName(lawan)}* (Centaur ${global.db.data.users[lawan].centaur}) Lagi Berkelahi.\n\nTunggu ${lamaPertarungan} Menit Lagi Dan Lihat Siapa Yang Menang.`, fkontak) // Ditambahkan fkontak
