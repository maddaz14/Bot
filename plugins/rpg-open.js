...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 1) {
                        ...
                        global.db.data.users[m.sender].petfood += lmz * 1
                        global.db.data.users[m.sender].lastopen = new Date * 1
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 10) {
                        ...
                        global.db.data.users[m.sender].petfood += lme * 1
                        global.db.data.users[m.sender].lastopen = new Date * 1
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 100) {
                        ...
                        global.db.data.users[m.sender].petfood += lmk * 1
                        global.db.data.users[m.sender].lastopen = new Date * 1
...
`.trim()
                    if (global.db.data.users[m.sender].boxs >= 1000) {
                        ...
                        global.db.data.users[m.sender].petfood += lmo * 1
                        global.db.data.users[m.sender].lastopen = new Date * 1
...
`.trim()  
        ...
        case 'pet':
            ...
            let _pet = `${pickRandom(['kucing', 'rubah','naga','kuda','anjing'])}`.trim()
    ...
    global.db.data.users[m.sender].petfood += mknp * 1;
...
handler.tags = ['rpg']
handler.command = /^(opencrate|open)$/i
